      ...
      <button
        ...
        className={
          variant === "cta"
            ...
            : "flex h-[52px] w-full items-center justify-center rounded-full bg-ink text-[15px] font-bold text-warm-50 ring-1 ring-warm-700 transition-colors hover:bg-warm-700/40 active:opacity-90 disabled:opacity-60"
        }
      >
